...
;function h(h,d,k,r,i,c){return b._api?b._api(h,d,k,r,i,c):(b.q&&.q.push([h,d,k,r,i,c]),null)}return .q=[],(b)=>{function h(b){
"function"==typeof b[4]&&b[4](new Error(b))}var d=.q;if(d){for(var k=0;k<d.length;k++)h(d[k]);d.length=0,d.push=h}},function(){
